...
static TextStyle skipStyle = TextStyle(
  ...
  static TextStyle prayerNameAr1 = TextStyle(
      fontFamily: "Tajawal", fontSize: 14.sp, fontWeight: FontWeight.w700,color: ColorManger.greenColor);
  ...
  static TextStyle bottomNavTextUnSelceted = TextStyle(
      fontFamily: "Tajawal", fontSize: 14.sp, fontWeight: FontWeight.w500,color: Color(0xff8789A3));
  ...
  static TextStyle calenderTextMilady = TextStyle(
      fontFamily: "NotoSans", fontSize: 16.sp, fontWeight: FontWeight.w700,
